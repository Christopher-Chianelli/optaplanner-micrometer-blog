let schoolId = $( '#schoolSelect option:selected' ).text();
let autoRefreshIntervalId = null;

$('#schoolSelect').change(function() {
  schoolId = $( '#schoolSelect option:selected' ).text();
  refreshTimeTable();
});

function refreshTimeTable() {
  $.getJSON(`/timeTable/${schoolId}`, function (timeTable) {
...
function solve() {
  $.post(`/timeTable/${schoolId}/solve`, function () {
...
function stopSolving() {
  $.post(`/timeTable/${schoolId}/stopSolving`, function () {
...
function addLesson() {
  let subject = $("#lesson_subject").val().trim();
